...
public class StringUtil {
    ...
    public static void main(String args[]) {
        ...
        System.out.println("16进制还原：" + back);

		String compressStr1 = gzip(s);
		System.out.println("压缩：" + compressStr1);
		String uncompressStr1 = gunzip(compressStr1);
		System.out.println("解压缩：" + uncompressStr1);

        String compressStr2 = zip(hex);
        System.out.println("压缩：" + compressStr2);
        String uncompressStr2 = unzip(compressStr2);
        System.out.println("解压缩：" + uncompressStr2);
    }
}
